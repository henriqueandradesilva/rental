...
public class PostMotorcycleValidationUseCase : IPostMotorcycleUseCase
{
    private IOutputPort<Domain.Entities.Motorcycle> _outputPort;
    private readonly IPostMotorcycleUseCase _useCase;
    private readonly NotificationHelper _notificationHelper;

    public PostMotorcycleValidationUseCase(
        IPostMotorcycleUseCase useCase,
