...
public class PutOrderValidationUseCase : IPutOrderUseCase
{
    private IOutputPort<Domain.Entities.Order> _outputPort;
    private readonly IPutOrderUseCase _useCase;
    private readonly NotificationHelper _notificationHelper;

    public PutOrderValidationUseCase(
        IPutOrderUseCase useCase,
