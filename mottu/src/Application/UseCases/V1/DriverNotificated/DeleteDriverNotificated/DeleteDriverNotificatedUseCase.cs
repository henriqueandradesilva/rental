...
namespace Application.UseCases.V1.DriverNotificated.DeleteDriverNotificated;

public class DeleteDriverNotificatedUseCase : IDeleteDriverNotificatedUseCase
{
    ...
    public DeleteDriverNotificatedUseCase(
