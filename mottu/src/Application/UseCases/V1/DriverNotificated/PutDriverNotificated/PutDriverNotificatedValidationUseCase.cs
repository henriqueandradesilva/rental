...
public class PutDriverNotificatedValidationUseCase : IPutDriverNotificatedUseCase
{
    private IOutputPort<Domain.Entities.DriverNotificated> _outputPort;
    private readonly IPutDriverNotificatedUseCase _useCase;
    private readonly NotificationHelper _notificationHelper;

    public PutDriverNotificatedValidationUseCase(
        IPutDriverNotificatedUseCase useCase,
