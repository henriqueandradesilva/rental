...
[ApiController]
public class PostDriverSetCnhImageController : CustomControllerBaseExtension, IOutputPort<Domain.Entities.Driver>
{
    private IActionResult _viewModel;
    private readonly NotificationHelper _notificationHelper;

    public PostDriverSetCnhImageController(
    ...
    public async Task<IActionResult> PutDriverSetCnhImage(
        [FromServices] IPutDriverSetCnhImageUseCase useCase,
        [FromRoute][Required] long id,
        [FromBody][Required] PostDriverSetCnhImageRequest postDriverSetCnhImageRequest)
    {
        ...
        await useCase.Execute(id, postDriverSetCnhImageRequest.Imagem_Cnh);
