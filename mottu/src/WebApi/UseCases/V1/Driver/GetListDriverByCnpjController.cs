...
[ApiController]
public class GetListDriverByCnpjController : CustomControllerBaseExtension, IOutputPortWithNotFound<List<Domain.Entities.Driver>>
{
    private IActionResult _viewModel;
    private readonly NotificationHelper _notificationHelper;

    public GetListDriverByCnpjController(
    ...
    [SwaggerOperation(Summary = "Consultar entregadores por Cnpj")]
    public async Task<IActionResult> GetDriver(
        [FromServices] IGetListDriverByCnpjUseCase useCase,
        [FromRoute][Required] string cnpj)
    {
